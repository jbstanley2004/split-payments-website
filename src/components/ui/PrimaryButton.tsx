    ...
    if (variant === "outline-orange") {
      return (
        <button
          ref={ref}
          className={cn(
            "inline-flex items-center justify-center rounded-full border-2 border-[#ff6b30] bg-transparent px-8 py-4 font-poppins font-medium text-lg tracking-tight text-[#ff6b30] transition-all duration-300 hover:bg-[#ff6b30]/8 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#ff6b30] disabled:opacity-50 disabled:pointer-events-none",
            className
          )}
          {...props}
        >
