  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      <motion.div
        ...
        style={{
          maskImage:
            "radial-gradient(circle at 50% 44%, rgba(0,0,0,0.78) 0%, rgba(0,0,0,0.95) 48%, rgba(0,0,0,0.88) 68%, rgba(0,0,0,0.45) 88%, rgba(0,0,0,0.1) 100%)",
          WebkitMaskImage:
            "radial-gradient(circle at 50% 44%, rgba(0,0,0,0.78) 0%, rgba(0,0,0,0.95) 48%, rgba(0,0,0,0.88) 68%, rgba(0,0,0,0.45) 88%, rgba(0,0,0,0.1) 100%)",
      ...
      >
        <div
          ...
          style={{ filter: "blur(1px)", opacity: 0.22 }}
        >
          {fragments.map((fragment, index) => (
            <span
              key={`${fragment}-${index}`}
              className="text-[9px] sm:text-[10px] md:text-xs font-semibold tracking-[0.28em] uppercase text-slate-500/80"
