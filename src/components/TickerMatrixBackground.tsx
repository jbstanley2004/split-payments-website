    ...
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      ...
      >
        <div
          ...
          style={{ filter: "blur(1.4px)", opacity: 0.12 }}
        >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 50% 46%, rgba(255,255,255,0.82) 0%, rgba(255,255,255,0.6) 34%, rgba(255,255,255,0.32) 60%, rgba(255,255,255,0.14) 76%, transparent 92%)"
        }}
      />
    </div>
  );
