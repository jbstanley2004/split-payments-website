  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-4 md:bottom-6 px-6 md:px-10 lg:px-16">
      <div className="relative mx-auto max-w-6xl overflow-hidden">
        ...
        <div className="flex items-center justify-between gap-4 sm:gap-6 rounded-2xl px-4 sm:px-5 py-3 backdrop-blur-md backdrop-saturate-75 bg-white/60 border border-white/50 opacity-80 shadow-[0_12px_60px_-46px_rgba(0,0,0,0.32)] text-slate-500/70">
          <div className="flex flex-col gap-1">
            <OdometerText text={formattedTotal} className="text-lg sm:text-xl md:text-[26px] font-semibold text-slate-500/80 font-poppins" />
            <span className="text-[8.5px] sm:text-[9px] font-semibold uppercase tracking-[0.24em] text-slate-500/70">
              {active.totalLabel}
            </span>
          </div>

          <div className="flex flex-col items-center text-center md:items-start md:text-left gap-1">
            <span className="text-[8.5px] sm:text-[9px] font-bold uppercase tracking-[0.24em] text-slate-500/70">
              {active.chartLabel}
            </span>
            <OdometerText text={formattedChart} className="text-base sm:text-lg md:text-[19px] font-semibold text-slate-500/80 font-poppins" />
          </div>

          <div className="flex items-center gap-3 text-[10.5px] sm:text-[11px] font-poppins text-slate-500/75">
