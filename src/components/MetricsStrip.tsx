  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-4 md:bottom-6 px-6 md:px-10 lg:px-16">
      <div className="relative mx-auto max-w-6xl overflow-hidden">
        ...
        <div className="flex items-center justify-between gap-6 rounded-2xl px-5 py-3 backdrop-blur-sm bg-white/70 opacity-85 shadow-[0_12px_60px_-42px_rgba(0,0,0,0.4)]">
          <div className="flex flex-col gap-1">
            <OdometerText text={formattedTotal} className="text-2xl sm:text-[28px] font-semibold text-slate-800/80 font-poppins" />
            <span className="text-[9px] font-semibold uppercase tracking-[0.24em] text-slate-500/80">
              {active.totalLabel}
            </span>
          </div>

          <div className="flex flex-col items-center text-center md:items-start md:text-left gap-1">
            <span className="text-[9px] font-bold uppercase tracking-[0.24em] text-slate-500/80">
              {active.chartLabel}
            </span>
            <OdometerText text={formattedChart} className="text-lg sm:text-xl font-semibold text-slate-700/80 font-poppins" />
          </div>

          <div className="flex items-center gap-3 text-[11px] text-slate-500/85 font-poppins">
            <div className="hidden sm:flex items-center gap-2 min-w-[160px] justify-end">
              ...
              <div className="relative h-4 overflow-hidden">
                <AnimatePresence initial={false} mode="popLayout">
                  <motion.span
                    ...
                    className="block leading-4 text-slate-500/90"
                  >
                    {activeStatus}
                  </motion.span>
                </AnimatePresence>
            ...
            <div className="relative flex h-2 w-2">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#FF4306] opacity-70" />
