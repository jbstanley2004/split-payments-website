        ...
        return (
            <div className="space-y-4">
                ...
                >
                    ...
                    <div className="flex flex-col gap-3 sm:gap-2 items-start sm:items-end w-full sm:w-auto text-left sm:text-right">
                        <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-black/5 text-black text-xs font-semibold uppercase tracking-wide w-full sm:w-auto justify-center sm:justify-start">
                            <Shield className="w-4 h-4" /> Secure Upload
                        </div>
                        {!isUploaded ? (
                            <span className="text-sm font-bold text-black border-b-2 border-black/10 group-hover:border-[#FF4306] transition-colors pb-0.5 font-poppins w-full sm:w-auto">
                                Upload Files
                            </span>
                        ) : (
                            <span className="text-xs font-bold text-green-600 bg-green-50 px-3 py-1.5 rounded-full font-poppins w-full sm:w-auto text-center">
                                Add More
                            </span>
                        )}
                    </div>
