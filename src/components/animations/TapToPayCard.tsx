                    ...
                    <div className="p-4">
                        <div className="flex items-start justify-between">
                            <div className="space-y-1.5 flex-1 min-w-0">
                                ...
                                <p className="text-sm text-brand-black/70 leading-snug">Secure contactless acceptance right from the devices your team already uses.</p>
                                <p className="text-sm text-brand-black/60 leading-snug">Provision fast, stay PCI-safe, and hand customers quick digital receipts.</p>
                            </div>
