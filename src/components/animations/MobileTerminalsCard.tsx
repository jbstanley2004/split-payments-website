                    ...
                    <div className="p-4">
                        <div className="flex items-start justify-between">
                            <div className="space-y-1.5 flex-1 min-w-0">
                                ...
                                <p className="text-sm text-brand-black/70 leading-snug">Table, curb, or queue—every payment stays fast and fully connected.</p>
                                <p className="text-sm text-brand-black/60 leading-snug">Strong battery life and prompts that keep tipping and tabs smooth.</p>
                            </div>
