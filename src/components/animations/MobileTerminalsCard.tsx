...
export default function MobileTerminalsCard({
    ...
    return (
        ...
        >
            ...
            >
                <motion.div
                    className="relative w-full h-full rounded-2xl overflow-hidden bg-brand-black"
                    animate={{ scaleX: isExpanded ? 0.96 : 1 }}
                    transition={{ duration: 0.55, ease: "easeInOut" }}
                >
                    <div className="absolute inset-0 w-full h-full [&>iframe]:absolute [&>iframe]:inset-0 [&>iframe]:w-[115%] [&>iframe]:h-[115%] [&>iframe]:-left-[7.5%] [&>iframe]:-top-[7.5%]">
