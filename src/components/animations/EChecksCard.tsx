...
export default function EChecksCard({ isExpanded = false, onExpand, expandDirection = "down", hasBeenViewed = false }: EChecksCardProps = {}) {
    ...
    return (
        <div
            className={`group bg-white rounded-3xl border ${viewedBorderClass} overflow-hidden shadow-sm transition-all duration-700 hover:shadow-md relative hover:z-10 ${isExpanded ? 'scale-110' : 'hover:scale-110'} origin-center`}
                    ...
                    <div className="p-4">
                        <div className="flex items-start justify-between">
                            <div className="space-y-1.5 flex-1 min-w-0">
                                ...
                                <p className="text-sm text-brand-black/70 leading-snug">Automated acceptance with fewer returns and happier accounting teams.</p>
                                <p className="text-sm text-brand-black/60 leading-snug">Verification and sync keep reconciliation clean for finance.</p>
                            </div>
