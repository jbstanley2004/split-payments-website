            ...
            <div className="mt-auto w-full bg-gray-50 relative border-t border-gray-100 overflow-hidden">
                <div className="h-96 w-full relative overflow-hidden">
                    <iframe
                        ...
                        src="https://www.youtube.com/embed/5BGXdPSNVDU?autoplay=1&mute=1&loop=1&playlist=5BGXdPSNVDU&playsinline=1&controls=0&modestbranding=1&showinfo=0&rel=0"
                        title="E-Checks Video"
