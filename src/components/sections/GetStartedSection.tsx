  ...
  return (
    ...
    >
      <div className="mx-auto max-w-3xl text-center">
        <p className="mb-3 text-xs font-semibold uppercase tracking-[0.16em] text-subtle">
          Get started
        </p>
        ...
        <p className="mt-4 text-sm sm:text-base md:text-lg font-lora text-subtle max-w-2xl mx-auto">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3 text-xs md:text-sm text-subtle">
