  ...
  return (
    <main className="min-h-screen bg-white text-black font-poppins selection:bg-black/10 selection:text-black">
      <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                <Link href="/get-started">
                  <PrimaryButton
                    ...
                    className="w-full sm:w-auto shadow-none hover:shadow-none hover:scale-100 active:scale-100"
                  >
                    Get started
                  </PrimaryButton>
                </Link>
                <Link href="/get-started">
                  <PrimaryButton className="w-full sm:w-auto bg-brand-black text-white shadow-none hover:shadow-none hover:scale-100 active:scale-100">
                    Contact sales
                  </PrimaryButton>
                </Link>
              </div>
        ...
        {/* CTA SECTION */}
        <section className="px-6 md:px-10 lg:px-16 py-20 md:py-32 text-center bg-[#F6F5F4] border-t border-brand-stone/50 md:min-h-[100dvh] flex items-center justify-center">
