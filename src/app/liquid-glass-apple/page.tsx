        ...
        <body>
          ...
          <div class="content">
            ...
            <ul>
              ...
              <li><strong>Gaussian Blur Sampling</strong> - 13×13 adaptive blur with circular masking</li>
          ...
          \`
            ...
            <h3 style="margin: 0 0 16px 0; font-size: 16px; font-weight: 600; color: #222; text-align: center;">🍎 Liquid Glass Controls</h3>
