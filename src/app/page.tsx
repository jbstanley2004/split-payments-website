      ...
      <div className="relative z-10 bg-bg">
        ...
        <header className="fixed top-3 left-0 right-0 z-50 flex items-center justify-center px-6 pointer-events-none">
          ...
          >
            ...
            >
              <Link href="/#funding" className="text-xs text-white/80 hover:text-[#00D9FF] transition-colors font-medium whitespace-nowrap">
                funding
              </Link>
            </motion.div>
            ...
            <motion.div
              ...
              style={{ pointerEvents: isHovered ? 'auto' : 'none' }}
            >
              <Link href="/payments" className="text-xs text-white/80 hover:text-[#00D9FF] transition-colors font-medium whitespace-nowrap">
                payments
              </Link>
            </motion.div>
            ...
            <motion.div
              ...
              style={{ pointerEvents: isHovered ? 'auto' : 'none' }}
            >
              <Link href="/industries" className="text-xs text-white/80 hover:text-[#00D9FF] transition-colors font-medium whitespace-nowrap">
                industries
              </Link>
            </motion.div>
