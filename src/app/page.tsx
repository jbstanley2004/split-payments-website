  ...
  return (
    <main ref={ref} className="relative min-h-screen font-lora text-text">
      ...
      <div className="relative z-10">
        ...
        {/* Hero Content */}
        <section className="min-h-screen flex items-end justify-center text-center pb-24 md:pb-32">
          <motion.div
        ...
        <section className="px-6 md:px-10 py-32 md:py-48 min-h-[80vh] flex items-center border-b border-line/50">
          ...
          >
            ...
            <p className="font-lora text-gray-700 dark:text-gray-700 text-lg md:text-xl mb-8 leading-relaxed">
        ...
        <section className="px-6 md:px-10 py-16 md:py-24 border-b border-line/50">
          ...
          >
            ...
            <p className="font-lora text-gray-700 dark:text-gray-700 mb-8 text-lg leading-relaxed">
