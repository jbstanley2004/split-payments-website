  ...
  return (
    <main className="relative min-h-screen min-h-[100dvh] font-lora text-text">
      ...
      <div className="relative z-10 min-h-screen min-h-[100dvh]">
        ...
        {/* Hero Content */}
        <section className="px-6 md:px-10 min-h-screen min-h-[100dvh] flex items-center justify-start text-left">
          <motion.div
            initial={{ opacity: 0, translateY: 30 }}
            animate={{ opacity: 1, translateY: 0 }}
            transition={{ duration: 0.9, ease: [0.25, 0.1, 0.25, 1] }}
            className="flex flex-col items-start gap-10 max-w-2xl"
          ...
          >
            ...
            <p className="text-lg md:text-xl lg:text-2xl font-lora text-[var(--theme-text-secondary)]">
