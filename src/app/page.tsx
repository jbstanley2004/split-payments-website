  ...
  return (
    <main className="relative min-h-screen font-jetbrains text-text">
      ...
      <div className="relative z-10 bg-bg">
        ...
        {/* Hero */}
        <section className="px-6 md:px-10 py-16 md:py-24 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-0 border-b border-line/50">
          <motion.div
          ...
          >
            <Image
              ...
              width={720}
              height={480}
              className="w-full md:w-full md:max-w-none object-contain"
        ...
        <section
          id="funding"
          className="px-6 md:px-10 py-16 md:py-24 flex flex-col md:flex-row-reverse items-center justify-between gap-12 md:gap-0 border-b border-line/50"
        >
          <motion.div
        ...
        <section
          id="pos"
          className="px-6 md:px-10 py-16 md:py-24 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-0 border-b border-line/50"
        >
          <motion.div
