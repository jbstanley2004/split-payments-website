  ...
  return (
    <main className="relative min-h-screen min-h-[100dvh] min-h-[100svh] bg-[#FAF9F5] font-lora text-[#141413]">
      ...
      <div className="relative z-10">
        ...
        <div className="px-6 pb-20 pt-32 sm:px-8 md:px-12 lg:px-16">
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-16">
            ...
            <section className="flex flex-col gap-4">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                ...
                <p className="text-sm text-[#524F49] sm:max-w-md">
            ...
            <section className="flex flex-col gap-6">
              ...
              <div className="grid gap-4 lg:grid-cols-3">
                {economicsBreakdown.map((item) => (
                  <div key={item.label} className="rounded-3xl border border-[#E8E6DC] bg-[#FAF9F5] p-5">
            ...
            <section>
              <div className="rounded-[36px] bg-[#141413] p-8 text-[#FAF9F5] shadow-[0_30px_80px_rgba(20,20,19,0.5)]">
                <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                  ...
                  <div className="flex flex-col gap-4">
                    <OrangePushButton>Book a partner session</OrangePushButton>
                    <span className="text-sm text-[#E8E6DC]">No obligation. No hard credit pulls for your merchants.</span>
                  </div>
                </div>
              </div>
            </section>
