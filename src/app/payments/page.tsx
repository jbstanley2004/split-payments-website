      ...
      <div className="relative z-10">
        ...
        <section className="w-full bg-[#F6F5F4] px-6 md:px-10 lg:px-16 py-16 md:py-24">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid gap-8 md:grid-cols-2 mb-8 relative items-stretch">
              <motion.div
                className="relative min-h-[360px] flex"
              ...
              >
                <div
                  className={`w-full h-full transition-opacity duration-300 ${expandedCard === 'mobile-wireless' ? 'opacity-0 invisible pointer-events-none' : 'opacity-100 visible'}`}
                >
                  <OnlineEcommerceCard
              ...
              >
                <div
                  className={`w-full h-full transition-opacity duration-300 ${expandedCard === 'payment-gateway' ? 'opacity-0 invisible pointer-events-none' : 'opacity-100 visible'}`}
                >
                  <MobileTerminalsCard
            ...
            <div className="grid gap-8 md:grid-cols-2 mb-8 relative items-stretch">
              ...
              >
                <div
                  className={`w-full h-full transition-opacity duration-300 ${expandedCard === 'tap-to-pay' ? 'opacity-0 invisible pointer-events-none' : 'opacity-100 visible'}`}
                >
                  <EChecksCard
              ...
              >
                <div
                  className={`w-full h-full transition-opacity duration-300 ${expandedCard === 'integrations' ? 'opacity-0 invisible pointer-events-none' : 'opacity-100 visible'}`}
                >
                  <TapToPayCard
