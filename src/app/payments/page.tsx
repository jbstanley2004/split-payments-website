          ...
          <div className="max-w-6xl w-full text-center relative z-10">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                ...
                <Link href="/get-started">
                  <button className="w-full sm:w-auto px-8 py-4 rounded-full bg-[#F6F5F4] text-black font-poppins font-medium text-lg border-2 border-[#e2e0dc] transition-colors hover:bg-[#eceae8] hover:border-[#d8d6d2]">
                    Contact sales
                  </button>
                </Link>
              </div>
