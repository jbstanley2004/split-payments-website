              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                <Link href="/get-started">
                  <PrimaryButton
                    ...
                    className="w-full sm:w-auto shadow-[0_18px_38px_-28px_rgba(255,84,0,0.65)]"
                  >
                    Get started
                  </PrimaryButton>
                </Link>
                <Link href="/get-started">
                  <button className="w-full sm:w-auto px-8 py-4 rounded-full bg-[#F6F5F4] text-black font-poppins font-medium text-lg border-2 border-[#e6e1d8] transition-colors shadow-none hover:bg-[#f1efed]">
                    Contact sales
                  </button>
                </Link>
              </div>
          ...
          <div className="relative z-10 px-6 md:px-10 lg:px-16 py-24 mx-auto max-w-4xl text-center">
            ...
            <div className="flex justify-center">
              <Link href="/get-started">
                <PrimaryButton
                  variant="gradient-border"
                  className="shadow-2xl hover:shadow-[0_20px_50px_rgba(0,0,0,0.2)] transform hover:-translate-y-1 transition-all scale-110"
                >
                  Get started
                </PrimaryButton>
              </Link>
