        ...
        <div className="stacked-shell mx-auto max-w-6xl overflow-hidden">
          ...
          <section className="px-6 md:px-10 lg:px-16 pt-24 md:pt-28 pb-20 max-w-6xl mx-auto">
            ...
            <div className="grid gap-10 lg:grid-cols-[minmax(0,1.7fr)_minmax(0,1.1fr)] items-start">
              {/* Form card */}
              <div className="stacked-panel rounded-3xl bg-[#E8E6DC] border border-[#E5DFD0] px-6 py-7 md:px-8 md:py-8">
              ...
              <aside className="stacked-panel rounded-3xl bg-[#FAF9F5] border border-[#E5DFD0] px-5 py-6">
