...
2. Provide environment variables for Firebase-backed persistence (if omitted, the MCP falls back to in-memory storage so you can still connect without timeouts while testing):
   ```bash
